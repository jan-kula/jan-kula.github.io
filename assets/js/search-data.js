...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "Here is some information that is relevant to any prospect employer and some of my interests. You can also download my cv here!",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%61%6E.%6B%75%6C%61@%6C%69%76%65.%73%65", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/jan-kula", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/jankula/", "_blank");
        },
      },{
        id: 'social-cv',
        title: 'CV',
